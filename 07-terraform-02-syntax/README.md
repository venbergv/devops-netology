...
```
![YC](/07-terraform-02-syntax/img/1.png)
...
*Ссылка на соответствующий [репозиторий](https://github.com/venbergv/devops-netology/tree/main/07-terraform-02-syntax/terraform/)*
